...
{expect} = require 'chai'
EnqueueJobsForWebhooksUnregistertSent = require '../'

describe 'EnqueueJobsForWebhooksUnregistertSent', ->
  beforeEach (done) ->
    @datastore = new Datastore
      database: mongojs('meshblu-core-task-enqueue-jobs-for-webhooks-unregister-sent')
      collection: 'devices'
  ...
  beforeEach ->
    client = new RedisNS 'ns', redis.createClient(@redisKey)
    @sut = new EnqueueJobsForWebhooksUnregistertSent {
      datastore:         @datastore
